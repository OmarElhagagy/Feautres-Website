  ...
  return (
    <li className="bg-white p-4 rounded shadow">
      <Link to={`/updates/${update.id}`} className="block">
        ...
        <p className="text-gray-600">{update.description || update.body || 'No description'}</p>
        <div className="flex justify-between text-sm mt-2">
          <span>{update.updatedAt ? new Date(update.updatedAt).toLocaleDateString() : 'Version: ' + update.version}</span>
          <span
